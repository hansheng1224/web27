...
INSERT INTO `que` (`id`, `text`, `count`, `parent`) VALUES
(1, '問題一：你最常做什麼運動來促進健康體能呢?', 6, 0),
(2, '1.健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1, 1),
(3, '2.仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 1, 1),
(4, '3.球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1, 1),
(5, '4.舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 3, 1),
(6, '問題二：二手菸沒有安全劑量，只要有暴露，就會有危險，請問它會造成身體上哪些危害?', 5, 0),
(7, '1.增加罹患冠狀動脈心臟病及罹病死亡之風險。', 1, 6),
(8, '2.對孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。', 2, 6),
...
(3, 'mobil01', '2308', 'mobil01@gmail.com'),
(4, 'abc', '1234', 'abc@gmail.com');
